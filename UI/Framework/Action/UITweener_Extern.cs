...
public abstract class UITweener_Extern : MonoBehaviour
{
	/// <summary>
	/// Current tween that triggered the callback function.
	/// </summary>
	
	static public UITweener_Extern current;
	...
	static public T Begin<T> (GameObject go, float duration) where T : UITweener_Extern
	{
