...
namespace Server
{
    public class Server_Game_FSM_NPC_Trader_State_Idle_Stand : Server_Game_FSM_State_Base
    {
        public Server_Game_FSM_NPC_Trader_State_Idle_Stand(Server_Game_FSM_Controller FSMController) : base(FSMController) { }
