...
{
	public uint EVENT_WEB_CARRIER_TIME_OUT = 0x1000000;
	public uint EVENT_WEB_NOT_REACHABLE = 0x1000001;
	
	public uint EVENT_WEB_SEND_HEART = 0x1000003;
	
	//索取版本信息//
	public uint EVENT_WEB_SEND_VERSION = 0x1000002;
	public uint EVENT_WEB_RECEIVE_VERSION = 0x1000004;
	
	//获取注册(登陆)结果//
	public uint EVENT_WEB_SEND_REGIST = 0x1000005;
	public uint EVENT_WEB_RECEIVE_REGIST = 0x1000006;
	public uint EVENT_WEB_SEND_HTTP_LOGIN = 0x1000007;
	public uint EVENT_WEB_RECEIVE_HTTP_LOGIN = 0x1000008;
	public uint EVENT_WEB_SEND_SOCKET_LOGIN = 0x1000009;
	public uint EVENT_WEB_RECEIVE_SOCKET_LOGIN = 0x100000a;

	public uint EVENT_WEB_SEND_TALK = 0x1000020;
	public uint EVENT_WEB_RECEIVE_TALK = 0x1000021;

	public uint EVENT_WEB_SEND_TASKID = 0x1000022;
	public uint EVENT_WEB_RECEIVE_REWARD_STRING = 0x1000023;
